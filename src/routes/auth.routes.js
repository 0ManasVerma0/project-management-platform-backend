...
import { registerUser, login, logoutUser, verifyEmail, refreshAccessToken, forgotPasswordRequest, resetForgotPassword, getCurrentUser, changePassword, resendEmailVerification } from "../controllers/auth.controllers.js";
